...
##  **!! Внимание, этот способ сгенерирован ИИ !! Я сам не знаю, но у меня работает данный способ так что используйте (смешно, но я лучше признаюсь, и поделюсь с способом для всех)**

# Как починить блокировку gist / githubusercontent.com (GitHub) без VPN и без правки скриптов
